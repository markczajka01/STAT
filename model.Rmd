...
## 1.1 GLM on LDLNTR
```{r}
glm_LDL <- glm(LDLNTR ~  WHOLGR1N + REFGRA1N + FIBRPER + BMISC + AGEC + SLPTIME + SYSTOL + EXLWTBC, family = "binomial", data = model_data)
summary(glm_LDL)
```

## 1.2 Ordinal on LDLRESB
```{r}
ordinal_LDL <- polr(LDLRESB ~ WHOLGR1N + REFGRA1N + FIBRPER + BMISC + AGEC + SLPTIME + SYSTOL + EXLWTBC, data = model_data)
summary(ordinal_LDL)
...
```{r}
multinom_LDL <- multinom(LDLRESB ~ WHOLGR1N + REFGRA1N + FIBRPER + BMISC + AGEC + SLPTIME + SYSTOL + EXLWTBC, data = model_data, trace=FALSE)
...
```{r}
glm_HDL <- glm(HDLCHREB_BINOM ~  WHOLGR1N + REFGRA1N + FIBRPER + BMISC + AGEC + SLPTIME + SYSTOL + EXLWTBC, family = "binomial", data = model_data)
summary(glm_HDL)
```
...
```{r}
ordinal_HDL <- polr(HDLCHREB ~ WHOLGR1N + REFGRA1N + FIBRPER + BMISC + AGEC + SLPTIME + SYSTOL + EXLWTBC, data = model_data)
summary(ordinal_HDL)
...
```{r}
multinom_HDL <- multinom(HDLCHREB ~ WHOLGR1N + REFGRA1N + FIBRPER + BMISC + AGEC + SLPTIME + SYSTOL + EXLWTBC, data = model_data, trace=FALSE)
...
## 3.1 GLM on CHOLNTR
```{r}
glm_CHOL <- glm(CHOLNTR ~  WHOLGR1N + REFGRA1N + FIBRPER + BMISC + AGEC + SLPTIME + SYSTOL + EXLWTBC, family = "binomial", data = model_data)
summary(glm_CHOL)
```
...
```{r}
ordinal_CHOL <- polr(CHOLRESB ~ WHOLGR1N + REFGRA1N + FIBRPER + BMISC + AGEC + SLPTIME + SYSTOL + EXLWTBC, data = model_data)
...
```{r}
multinom_CHOL <- multinom(CHOLRESB ~ WHOLGR1N + REFGRA1N + FIBRPER + BMISC + AGEC + SLPTIME + SYSTOL + EXLWTBC, data = model_data, trace=FALSE)
